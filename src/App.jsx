      ...
      {activeTab==="home"&&(
        <div className="px-4 pt-4 pb-24">
          ...
          <div className="p-3 rounded-xl mb-4 flex items-center gap-3" style={{ background:"#111",border:"1px solid #333" }}>
            ...
            <input type="number" value={bodyweight} onChange={e=>handleBwChange(e.target.value)} style={{ background:"transparent",border:"none",color:"#e8ff47",fontFamily:"'Bebas Neue',sans-serif",fontSize:20,width:70,padding:0 }}/>
